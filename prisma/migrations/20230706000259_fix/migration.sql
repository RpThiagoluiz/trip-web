/*
  ...
  - You are about to alter the column `pricePerDay` on the `Trip` table. The data in that column could be lost. The data in that column will be cast from `Integer` to `Decimal(8,2)`.
...
ALTER COLUMN "pricePerDay" SET DATA TYPE DECIMAL(8,2);

-- AlterTable
ALTER TABLE "TripReservation" ALTER COLUMN "totalPaid" SET DATA TYPE DECIMAL(8,2);
